...
def show_pro_preferences():
    ...
    # --- CREATOR TAB ---
        ...
        right_wrapper.pack(anchor="e", padx=15)  # moves whole row left from right edge
...
def main():
   ...
   # --- Right-aligned Start + Reload (aligned with buttons above) ---
    ...
    btn_row.pack(pady=(7, 5), anchor="e", padx=(0, 15))
    ...
    start_btn.pack(side="left", padx=(5, 5))
    ...
    reload_btn.pack(side="left", padx=(0, 0))
